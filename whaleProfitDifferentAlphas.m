function whaleProfitDifferentAlphas()
...
% Define the parameters
    ...
    K1 = 150000;
    K2 = 400000;
    alpha1 = 10^-8; % lowest alpha to give total max capacity: 10^-9.9023
    alpha2 = 10^-8; % highest alpha for max capacity greater than zero, capacity = 2152
